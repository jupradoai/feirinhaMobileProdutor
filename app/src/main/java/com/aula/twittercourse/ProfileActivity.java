            ...
            user.updatePassword(newPassword)
                    .addOnCompleteListener(task -> {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(ProfileActivity.this, "Erro ao atualizar a senha", Toast.LENGTH_SHORT).show();
                        }
                    });
        }
    }
            ...
            user.delete()
                    .addOnCompleteListener(task -> {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(ProfileActivity.this, "Erro ao excluir a conta", Toast.LENGTH_SHORT).show();
                        }
                    });
        }
    }
